...
class Question extends CI_Controller {
   ...
   public function index()
   {
      ...
      $arraySearch = array("id >"=>0) ;
       //****************************************
       $Data2 = $this->data->get("question",FALSE,$arraySearch,FALSE,TRUE,false,false,array("id"=>"id"));
       ...
       $data['setting']['data_in_page'] = 50 ;
        ...
        $paging["base_url"] = base_url().$index_Page."administrator/question/index";
        $paging["first_url"] = base_url().$index_Page."administrator/question/index".$this->config->item('url_suffix');
        $paging["suffix"] = $this->config->item('url_suffix');;
        $paging["total_rows"] = $this->data->countTable("question",$arraySearch);
        ...
        $data['data']   = $this->data->get("question",FALSE,$arraySearch,FALSE,TRUE,array("id"=>"asc"),array($data['setting']['data_in_page']=>$page));
     ...
     $this->load->view('administrator/pages/question',$data);
