...
//////////////////////////////
    ...
    $data['data']= $this->data->get("cats",FALSE,array());
...
// print_r($data['data']);exit();
    ...
    ///////////////////////////
     ...
     foreach ($data['data'] as $data) {
        $arrangeData[lang("CompanyName_ar")] = $data['name'];
        $arrangeData[lang("CompanyName_en")] = $data['name_en'];//$data['mobile'];
        $arrangeData[lang("Email")] = $data['email'];
         $arrangeData[lang("city")] = $this->getCity($data['city_id']);
         $arrangeData[lang("Username")] = $data['username'];
...
public function getCity($id){
  $sqldriver = "SELECT * from city_master where id =".$id." ";
            $query=$this->db->query($sqldriver);
            $valPer = $query->result_array();
            
            return $valPer[0]['city_name_en'].'-'.$valPer[0]['city_name_ar'];
