...
$data['langId']        = FALSE ;
    $data['data']        = $this->data->get("cats",$data['langId'],array("parent"=>0),FALSE,TRUE,array("id"=>"asc")) ;
     ...
     $this->load->view('administrator/global/header');
       $this->load->view('administrator/global/topbar');
       $this->load->view('administrator/global/menu');
       $this->load->view('administrator/pages/invoice_index',$data);
       $this->load->view('administrator/global/footer');
...
public function generateinvoice()
  {
    ...
    $data['langId']        = FALSE ;
    $data['data']          = $this->data->generateinvoice($_REQUEST['vendor_id'],$_REQUEST['month_id'],$_REQUEST['year_id']);
    
     $this->load->view('administrator/pages/generateinvoice',$data);
       //$this->load->view('administrator/global/footer');
    }else{
      redirect('administrator/orders/invoice/', 'refresh');
    }
  }
