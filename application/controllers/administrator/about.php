   ...
   public function index()
   {
    ...
    //$data['about'] = 
      $this->db->select('*');
       ...
       $this->load->view('administrator/pages/about_list',$data);
    ...
    //$data['about'] = 
      $this->db->select('*');
           ...
           if(isset($_REQUEST['post_id'])){
              ...
              redirect(site_url("administrator/about"));
           } 
       ...
       $this->load->view('administrator/global/topbar');
       $this->load->view('administrator/global/menu');
       $this->load->view('administrator/pages/about_form',$data);
       $this->load->view('administrator/global/footer');
