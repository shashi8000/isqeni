...
class Complaints extends CI_Controller {
   ...
   public function index()
   {
      ...
      $arraySearch = array("id >"=>0) ;
       //****************************************
       $Data2 = $this->data->get("complaints",FALSE,$arraySearch,FALSE,TRUE,array("created_date" => "desc"),false,array("id"=>"id"));
       ...
       $data['setting']['data_in_page'] = 50 ;
        ...
        $data['data']   = $this->data->get("complaints",FALSE,$arraySearch,FALSE,TRUE,array("created_date" => "desc"),array($data['setting']['data_in_page']=>$page));
