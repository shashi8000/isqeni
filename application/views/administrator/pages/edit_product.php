			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="<?php echo base_url('administrator/products/edit_product_confirm/'.$data['id']); ?>" method="post" enctype="multipart/form-data">
						  <fieldset>
					...
					<div class="control-group" id="titlegroup">
					  ...
					  <div class="controls">
						<input type="number" class="span6 typeahead" name="Cform[min_quantity]" value="<?php echo isset($data['min_quantity']) ? $data['min_quantity'] : '';?>" id="typeahead"  data-provide="typeahead" data-items="4" data-source='[]'>
...
<?php // $this->session->userdata('logged_in_customer')['id'];?>

						  	<input id="selectError4" name="Cform[cat_id]" value="<?=$data['cat_id'];?>" type="hidden">								
              ...
              <div class="control-group">
                <label class="control-label" for="selectError2"><?php echo lang("Companies") ;?></label>
                    <div class="controls">
                      <?php 
                          $sqlDelete = "select * from cats where id=".$data['cat_id'];
                          $query = $this->db->query($sqlDelete);
                          $val = $query->result();
                          if(!empty($val)){
                         // print_r($val);
                          	echo '<b>'.$val[0]->name.'  --  '.$val[0]->name_en;
                          	}
                      ?>
                          ...
                          <div class="control-group">
                              ...
                              <div class="input_fields_wrap">
                                ...
                                foreach($productchemicalcomposition as $key=>$productcomposition){?>
                                    ...
                                    <div class="col-md-12 text-center"><button class="text-danger"><a href="<?php echo base_url('administrator/products/deleteProductComposition/'. $productcomposition['id'].'/'.$data['id']); ?>"> Delete</a></button></div>
                                  <div class="control-group" id="titlegroup">
							...
							<div class="form-actions">
							  ...
							  <button type="reset" class="btn" onclick="window.location='<?php echo base_url();?>administrator/products.html';"><?php echo lang("Cancel") ;?></button>
