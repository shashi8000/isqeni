    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="<?= base_url('administrator/driver/add_driver');  ?>" method="post" enctype="multipart/form-data">
                    <fieldset>
...
<div class="control-group">
                              <label class="control-label" for="fileInput"><?php echo lang("Companies") ;?></label>
                              <div class="controls">
                            ...
                            <?php } ?> </select>
                                <?php }else{ //echo 124;exit(); ?><select  required name="vendor_id">
                                <option value=''>Please select vendor</option>
