    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="<?php echo base_url('administrator/coupon/edit_coupon_confirm/'.$data['id']); ?>" method="post" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="control-group" id="titlegroup">
                            ...
                            <div class="controls"><?php echo isset($data['coupon_code']) ? $data['coupon_code'] : ''; ?>
