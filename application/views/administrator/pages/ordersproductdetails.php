    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <legend><?php echo lang("Order_Details");?></legend>
                ...
                <table style="margin-bottom:1em;" width="600" cellpadding="0" cellspacing="0" align="center" class="table table-striped table-bordered bootstrap-datatable">
                    <tbody><tr align="left">
                        <th width="70%"><h2 style="color:rgba(51,51,51,1); font-size:20px; line-height:normal; font-weight:normal; margin-top:0; margin-bottom:0;"><?php echo lang("Shipped_To");?></h2></th>
                        <th><h2 style="color:rgba(51,51,51,1); font-size:20px; line-height:normal; font-weight:normal; margin-top:0; margin-bottom:0;"><?php echo lang("Status");?></h2></th>
                    </tr>
                    <tr>
                        ...
                        <td><h3 style="margin-top:0; margin-bottom:0; font-weight:normal; font-size:18px;"><?php
                                if($data[0]['order_status'] ==1){
									echo lang("PlacedOrder");
                                }elseif($data[0]['order_status'] ==2){
                                    echo lang("CancelOrder");
                                }elseif($data[0]['order_status'] ==3){
                                    echo lang("DeliveredOrder");
                                }elseif($data[0]['order_status'] ==4){
                                    echo lang("PendingOrder");
                                }
                        ?></h3></td>
                    </tr>
                    </tbody>
                    ...
                    <table style="width:100%" class="table table-striped table-bordered bootstrap-datatable">
                        ...
                        ?>
                                        ...
                                        <tbody><tr >
                                            <td><table  class="table table-striped table-bordered bootstrap-datatable">
                                                    <tbody><tr colspan="9">
                                                        ...
                                                        <th><?php echo lang("Vehicle_Type");?></th>
                                                        <th colspan="2"><?php echo lang("Vehicle_Details");?></th>
                                                        <th><?php echo lang("Driving_Licence_No");?></th>
                                                        <th><?php echo lang("Rate_and_feedback");?></th>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                           ...
                                                           // print_r($driverdetails);
                                                            ...
                                                            <br>
                                                            <?php echo lang("Contact_No");?> <strong><?php
                                                        ...
                                                        <td>
                                                            <?php if($this->config->config['language'] =='arabic'):?>
                                                                <?php echo lang("Color");?>:<strong><?php
                                                        ...
                                                        <td colspan="2">
                                                            ...
                                                            <?php endif; ?>
                                                            <br>
                                                            <?php echo lang("Number");?>: <strong><?php
                            ...
                            $this->db->where('order_id',$data_item['order_id']);
                            $query = $this->db->get();
        
                            $valCat = $query->result_array();
                            if(!empty($valCat)){
                                 echo $valCat[0]['rating'].'/5<br><br>'.$valCat[0]['feedback'];
                             }else{
                                echo 'N/A';
                             }
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><?php echo lang("coupon_sel");?></th>
                        ...
                        <tr>
                            <td colspan="8" style="text-align:right"><strong><?php echo lang("Order_Total");?>:</strong></td>
                            <td><strong><?php echo number_format($amount, 2);?>&nbsp;SAR</strong></td>
                        </tr>
                        </tbody>
                    </table>
