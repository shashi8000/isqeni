                           ...
                           ?>
                               ...
                               <?php echo $data_item['coupon_title'] ;?>
                                ...
                                <td class="center">
									...
									<a class="btn btn-info" href="<?php echo base_url('administrator/coupon/edit_coupon/'.$data_item['id']);?>" ><?php echo lang("Edit"); ?></a><!--href="<?php echo site_url("products/add/".$data_item['id']);?>"  
										<i class="icon-edit icon-white"></i>
                                        <?php echo lang("Edit") ;?>
									</a>
									-->

								<!--	<a onClick="#" class="btn btn-danger delete_rec" href="<?php echo base_url('administrator/coupon/delete_coupon/'.$data_item['id']);?>"><!--onClick="return confirm('<?php echo lang("WantDelete") ;?>')" href="<?php echo site_url("products/delete/".$data_item['id']);?>" -->
                  <!--
										<i class="icon-trash icon-white"></i>
