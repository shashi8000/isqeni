...
<div id="content" class="span10">
	...
	<div>
		<ul class="breadcrumb">
             ...
             <li>
			    <?php echo lang("Products") ;?>  <span class="divider">/</span>
			</li>
			<li>
			...
			<div class="box-content">
                 ...
                 <p class="help-block">	<?php echo isset($message) ?$message : ''  ;?>   </p>
					...
					<div class="control-group" id="titlegroup">
					  ...
					  <div class="controls">
						<input type="number" class="span6 typeahead" name="Cform[min_quantity]" value="<?php echo isset($data['min_quantity']) ? $data['min_quantity'] : '';?>" id="typeahead"  data-provide="typeahead" data-items="4" data-source='[]' required>
					   <p class="help-block">	<?php echo form_error('Cform[min_quantity]')  ;?>   </p>
					  <!--	<p class="help-block">Start typing to activate auto complete!</p>     -->
					  </div>
					</div>
                 ...
                 <div class="control-group" id="titlegroup">
                    ...
                    <div class="control-group">
						...
						<div class="controls">
						  <select id="selectError4" required name="Cform[cat_id]" data-placeholder="<?php echo lang("Companies") ;?>" data-rel="chosen" onChange="getState(this.value);">
						   <option></option>
