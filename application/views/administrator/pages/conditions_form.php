			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<?php echo lang("Edit");?> <?php echo lang("Conditions");?>
						<div class="box-icon">
					...
					<div class="control-group">
					  <label class="control-label" for="textarea2"><?php echo lang("Conditions");?></label>
					  <div class="controls">
					  ...
					  <div class="form-actions">
					  	<input type="hidden" name="post_id" value="<?php echo $data[0]->id; ?>">
							  ...
							  <button type="reset" class="btn" onclick="window.location='<?php echo site_url("administrator/conditions");?>';"><?php echo lang("Cancel");?></button>
							</div>		
						</form>
