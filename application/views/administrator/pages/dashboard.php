...
<div id="content" class="span10">
  ...
  <div class="container-2">
          ...
          <div class="circle-tile"> <a href="#">
            ...
            <div class="circle-tile-content dark-blue">
              ...
              <div class="circle-tile-number text-faded">
                  <?php
                  echo $table_row_count = $this->db->count_all('cats');
                  ?>
                  <span id="sparklineA"></span> </div>
              <a href="<?php echo base_url();?>administrator/cats.html" class="circle-tile-footer">More Info <i class="fa fa-chevron-circle-right"></i></a> </div>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6 info">
          <div class="circle-tile"> <a href="#">
            ...
            <div class="circle-tile-content green">
              ...
              <a href="<?php echo base_url();?>administrator/clients.html" class="circle-tile-footer">More Info <i class="fa fa-chevron-circle-right"></i></a> </div>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6 info">
          <div class="circle-tile"> <a href="#">
    ...
    <div class="box-content clearfix" style="direction:ltr"><h2 class="text-center">Top 10 Sell Products</h2>
      <div class="my-graph"> 
...
var chart = AmCharts.makeChart("chartdiv", {
  ...
  "dataProvider": [
	<?php
      foreach ($rows as $row){
      $this->db->where('vendor_id',$row['cat_id']);
      $this->db->from('order_item');
      $count = $this->db->count_all_results();
      ?>{
    "country": "<?php echo $row['name_en'];?>",
    "visits": <?php echo $count;?>,
    "color": "#<?php echo $six_digit_random_number = mt_rand(100000, 999999);?>"
  }, 
	  <?php } ?>
  ],
  "valueAxes": [{
...
jQuery('.chart-input').off().on('input change', function() {
  ...
  $("#pieChart").drawPieChart([
        ...
        foreach ($rows as $row){
          ...
          $count = $this->db->count_all_results();
        ?>
         { title: "<?php echo $row['name_en'];?>", value : <?php echo $count;  ?>, color: "#<?php echo $six_digit_random_number = mt_rand(100000, 999999);?>" },
        <?php
        }?>
...
;(function($, undefined) {
  ...
  $("#doughnutChart").drawDoughnutChart([
      <?php
      foreach ($rows as $row){
      $this->db->where('vendor_id',$row['id']);
      $this->db->from('order_item');
      $counts = $this->db->count_all_results();
      ?>
    {title:"<?php echo $row['name_en'];?>", value:<?php echo $counts;?>,color:"#<?php echo $six_digit_random_number = mt_rand(100000, 999999);?>"},
    <?php } ?>
  ]);
});
/*!
