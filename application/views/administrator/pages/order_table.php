...
<div id="content" class="span10">
    ...
    <div>
        <ul class="breadcrumb">
            <li>
                <?php echo lang("Orders") ;?> <span class="divider">/</span>
            </li>
            <li>
                <?php echo lang("Orders_List")?>
            </li>
        </ul>
    </div>
    <div class="clear"></div>
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <form action="<?php echo site_url("administrator/orders/fetchDataFromTable/") ?>" method="post" id="table_form">
            <div class="col-md-6" style="text-align: right;"><button type="submit" class="btn btn-primary"><?php echo lang("Export_Report");?></button></div>
              <input type="hidden" name="from" value="<?php echo (isset($_REQUEST['from']))?$_REQUEST['from']:''; ?>" />
              <input type="hidden" name="to" value="<?php echo (isset($_REQUEST['to']))?$_REQUEST['to']:''; ?>" />
              <input type="hidden" name="pay" value="<?php echo (isset($_REQUEST['pay']))?$_REQUEST['pay']:''; ?>" />
                    ...
                    ?>
                                ...
                                <td class="center">
                                    ...
                                    <a class="btn btn-info" href="<?php echo site_url("administrator/orders/viewproductdetails/".$data_item['order_id']);?>">
                                        <i class="fa fa-eye icon-white"></i><?php echo lang("Views");?>
                                    </a>
