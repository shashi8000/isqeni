  ...
  <div class="well nav-collapse sidebar-nav">
    <ul id="accordion" class="nav nav-tabs nav-stacked main-menu accordion">
      ...
      <li class="nav-header hidden-tablet dashboard-menu">
        <div class="link"> <a href="<?php echo site_url("administrator/dashboard")?>"><i class="fa fa-dashboard"></i>Dashboard</a></div></li>
...
<ul class="submenu" <?php if($this->uri->segment(2) == "home" || $this->uri->segment(2) == "about" || $this->uri->segment(2) == "conditions") { echo "style='display:block'"; }  ?>>      <li><a class="ajax-link" href="<?php echo site_url("administrator/home")?>"><i class="icon-home"></i><span class="hidden-tablet"> <?php echo lang("Messages")?> <span style="color: yellow; font-size: 13px; font-weight: bold;">( <?php echo $this->data->countTable("contact",array("read"=>"0"));?> )</span></span></a></li>
      ...
      <li><a class="ajax-link" href="<?php echo site_url("administrator/driver/view_all")?>"><i class="icon-globe"></i><span class="hidden-tablet"><?=lang("Driver_List")?> </span></a></li>
       ...
       <li class="nav-header hidden-tablet <?php if($this->uri->segment(1) == "orders" || $this->uri->segment(1) == "orders" || $this->uri->segment(1) == "conditions"){ echo "open";}  ?>">
           ...
           <ul class="submenu" <?php if($this->uri->segment(2) == "orders" || $this->uri->segment(1) == "orders" || $this->uri->segment(1) == "conditions") { echo "style='display:block'"; }  ?>>
               <li><a class="ajax-link" href="<?php echo site_url("administrator/orders/index")?>"><i class="icon-globe"></i><span class="hidden-tablet">Orders List</span></a></li>
           </ul>
       </li>
...
<?php if (in_array("1",$this->session->userdata('permi')) || in_array("6",$this->session->userdata('permi'))) { ?>
    <li class="nav-header hidden-tablet <?php if($this->uri->segment(2) == "coupon" || ($this->uri->segment(3) == "add" && $this->uri->segment(2) == "coupon")) { echo "open"; }  ?>">
        <div class="link"><i class="fa fa-tags"></i><?=lang("coupon")?>Coupon<i class="fa fa-chevron-down"></i></div>
        <ul class="submenu" <?php if($this->uri->segment(2) == "coupons" || ($this->uri->segment(3) == "add" && $this->uri->segment(2) == "coupon")) { echo "style='display:block'"; }  ?>>
            <li><a class="ajax-link" href="<?php echo site_url("administrator/coupon/")?>"><i class="icon-user"></i><span class="hidden-tablet"> <?php echo lang("Show")?></span></a></li>
			<li><a class="ajax-link" href="<?php echo site_url("administrator/coupon/addadmin")?>"><i class="icon-plus-sign"></i><span class="hidden-tablet"> <?php echo lang("add")?>Add</span></a></li>
            <li><a class="ajax-link" href="<?php echo site_url("administrator/coupon/add")?>"><i class="icon-plus-sign"></i><span class="hidden-tablet"> Assign Multiple Products</span></a></li>
        </ul>
    </li>
<?php } ?>
  ...
  <div class="link"><i class="fa fa-shopping-bag"></i><?=lang("PurchaseordersandSales")?><i class="fa fa-chevron-down"></i></div>      <ul class="submenu" <?php if($this->uri->segment(2) == "orders" || ($this->uri->segment(3) == "companies" && $this->uri->segment(2) == "orders")) { echo "style='display:block'"; }  ?>>   <li><a class="ajax-link" href="<?php echo site_url("administrator/orders/")?>"><i class="icon-globe"></i><span class="hidden-tablet"> <?php echo lang("Show")?></span></a></li>
     ...
     <?php if (in_array("1",$this->session->userdata('permi')) || in_array("8",$this->session->userdata('permi'))) { ?>
	  ...
	  <?php if (in_array("1",$this->session->userdata('permi')) || in_array("8",$this->session->userdata('permi'))) { ?>
        ...
        <div class="link"><i class="fa fa-male"></i>Vendor Permissions<i class="fa fa-chevron-down"></i></div><ul class="submenu" <?php if($this->uri->segment(2) == "vendorpermi" || ($this->uri->segment(3) == "add" && $this->uri->segment(2) == "vendorpermi")) { echo "style='display:block'"; }  ?>>
                 <li><a class="ajax-link" href="<?php echo site_url("administrator/vendorpermi/")?>"><i class="icon-user"></i><span class="hidden-tablet"> Permission Master</span></a></li>
      <li><a class="ajax-link" href="<?php echo site_url("administrator/vendorpermi/add")?>"><i class="icon-plus-sign"></i><span class="hidden-tablet"> Add Permission</span></a></li>
                 <li><a class="ajax-link" href="<?php echo site_url("administrator/vendorpermi/viewpermission")?>"><i class="icon-plus-sign"></i><span class="hidden-tablet"> View Permission</span></a></li></ul>
      </li>
