			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="<?php echo base_url('products/add_product');?>" method="post" enctype="multipart/form-data">
						  <fieldset>
					...
					<div class="control-group" id="titlegroup">
					  ...
					  <!--	<p class="help-block">Start typing to activate auto complete!</p>     -->
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input class="input-file uniform_on" id="fileInput" type="file" name="photo_to_up" required>
