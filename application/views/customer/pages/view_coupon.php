                                  ...
                                  <a class="btn btn-btn" href="javascript:showActivities('0');">
                                    ...
                                    <form method="post" name="multiple_upload_form0" id="multiple_upload_form0" enctype="multipart/form-data" action="<?php echo base_url()?>server/upload.php">
                                    	<input type="hidden" name="image_form_submit" value="0"/>
                                            <label><?php echo lang("Choose_Image"); ?></label>
                          ...
                          foreach($coupon AS $data_item){
                           ...
                           ?>
                               ...
                               <?php echo $data_item['coupon_title'] ;?>
                                ...
                                <td class="center">
								   	<a class="btn btn-info" href="<?php echo base_url('coupon/edit_coupon/'.$data_item['id']);?>" >
										<i class="icon-edit icon-white"></i>
                                        <?php echo lang("Edit") ;?>
									</a>
                  <!--
									<a onClick="#" class="btn btn-danger delete_rec" href="<?php echo base_url('coupon/delete_coupon/'.$data_item['id']);?>">
-->
                    <!--onClick="return confirm('<?php echo lang("WantDelete") ;?>')" href="<?php echo site_url("products/delete/".$data_item['id']);?>" -->
										<!--
