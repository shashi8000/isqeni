...
<div id="content" class="span10">
  ...
  <div class="container-2">
    ...
    <div class="box-content clearfix">
          ...
          <div class="circle-tile"> <a href="#">
            ...
            <div class="circle-tile-content dark-blue">
              ...
              <div class="circle-tile-number text-faded"><?php
                  $vendor_id=$this->session->userdata('logged_in_customer');
                  $vendor=$vendor_id['id'];
                  $this->db->where('cat_id',$vendor);
                  $this->db->where('customer_del',1);
                  $this->db->from('products');
                  echo $count = $this->db->count_all_results();
                  ?><span id="sparklineA"></span> </div>
              <a href="<?php echo site_url("products/")?>" class="circle-tile-footer">More Info <i class="fa fa-chevron-circle-right"></i></a> </div>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6 info">
          <div class="circle-tile"> <a href="#">
            ...
            <div class="circle-tile-content green">
              ...
              <div class="circle-tile-number text-faded"><?php
                  ...
                  echo $count = $this->db->count_all_results();
                  ?></div>
              <a href="<?php echo site_url("driver/view_all")?>" class="circle-tile-footer">More Info <i class="fa fa-chevron-circle-right"></i></a> </div>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6 info">
          <div class="circle-tile"> <a href="#">
            ...
            <div class="circle-tile-content blue">
              ...
              <div class="circle-tile-number text-faded"><?php
                  ...
                  $this->db->where('t2.vendor_id', $vendor);
                  $this->db->join('order_item as t2', 't1.id = t2.order_id', 'LEFT');
                  echo $count = $this->db->count_all_results();
				?><span id="sparklineB"></span> </div>
              <a href="<?php echo site_url("orders/")?>" class="circle-tile-footer">More Info <i class="fa fa-chevron-circle-right"></i></a> </div>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6 info">
          <div class="circle-tile"> <a href="#">
            ...
            <div class="circle-tile-content red">
              ...
              <a href="<?php echo site_url("coupon/view_coupon")?>" class="circle-tile-footer">More Info <i class="fa fa-chevron-circle-right"></i></a> </div>
          </div>
        </div>
      </div>
    </div>
      ...
      $PermissionsType=$this->data->checkPermissions($vendor_id['id']);
      foreach ($PermissionsType as $value){
      if($value['name'] == 'Dashboard Middle'){
      ?>
...
<?php }} ?>
      ...
      $PermissionsType=$this->data->checkPermissions($vendor_id['id']);
      foreach ($PermissionsType as $value){
      if($value['name'] == 'Dashboard Bottom'){
      ?>
