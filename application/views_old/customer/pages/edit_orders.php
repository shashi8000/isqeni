	...
	<div>
		<ul class="breadcrumb">
			<li>
             ...
             <li>
			   <a href="<?php echo site_url("orders")?>"><?php echo lang("Orders") ;?></a> <span class="divider">/</span>
			</li>
			<li>
				<?php echo lang("Edit") ;?>
			</li>
	...
	<div class="row-fluid sortable">
		<div class="box span12">
            ...
            <div class="control-group">
						<label class="control-label" for="selectError2"><?php echo lang("OrderStatus") ;?> </label>
						<div class="controls">
						  <select id="selectError4" name="status" data-placeholder="حالة الطلب" data-rel="chosen">
							<?php $status = get_this('orders',['id'=>$id]); ?>
							<option value="0" <?php if( $status['status'] == 0 ) echo"selected='selected'"; ?>><?php echo lang("Pending") ;?></option>
							<option value="1" <?php if( $status['status'] == 1 ) echo"selected='selected'"; ?>><?php echo lang("Shipped") ;?></option>
							<option value="2" <?php if( $status['status'] == 2 ) echo"selected='selected'"; ?>><?php echo lang("Delivered") ;?></option>
						  </select>
						</div>
					</div>
